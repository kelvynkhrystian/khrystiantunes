...
## Data de Entrega
  ...
  - Data de entrega para avaliação final do projeto: `27/05/2022 14:00`.
...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-021-b-project-trybetunes.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-021-b-project-trybetunes`
